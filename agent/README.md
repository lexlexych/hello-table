...
Пакет реализует локальный прототип итерации 3: немецкий разговор без инструментов,
бронирований, n8n и базы. Аудио и транскрипты не сохраняются; `AgentSession.start()` всегда
...
после полного воспроизведения этой фразы. Прототип честно отказывает в бронировании: у него
нет инструментов и он не должен изображать выполненное действие.
