...
`LOG_LEVEL=warn`. Портал поднят в объёме «вход, роли, тестовый звонок» (спека 004).
...
Портал (Next.js 16) даёт вход с ролями и один раздел — тестовый звонок из браузера.
...
сохраняется. Пошаговая проверка — `specs/004-portal-test-call/manual-tests.md`.
